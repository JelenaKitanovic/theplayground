...
{{--        </div>--}}
        <div
            ...
            <table class="min-w-full">
                <thead>
                <tr>
                    <th class="px-3 py-3 border-b-2 border-gray-300 text-left leading-4 text-blue-500 tracking-wider">
                        ID
                    </th>
                ...
                @foreach($customers as $customer)
                    <tr>
                        <td class="px-3 py-3 whitespace-no-wrap border-b border-gray-500">
